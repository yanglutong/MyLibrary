...
public class DBManager {
    ...
    public DBManager(Context context) throws SQLException {
        ...
        dao = ormHelper.getDao(DemoBean.class);
    }
     ...
     * @thro
     */
    public void insertdemoBean(DemoBean demoBean) throws SQLException {
     ...
     * @throws SQLException
     */
    public void batchInsert(List<DemoBean> demoBean) throws SQLException {
        dao.create(demoBean);
    }
     ...
     * @throws SQLException
     */
    public List<DemoBean> getdemoBeanList() throws SQLException {
        List<DemoBean> list = dao.queryForAll();
        return list;
    }
     ...
     * @throws SQLException
     */
    public List<DemoBean> querySelect(String key, String value) throws SQLException {
        //Eq是equals的缩写
        //方法1
...
//        queryBuilder.orderBy("age",true);
        ...
        List<DemoBean> query = queryBuilder.query();//此方法相当于build，提交设置
        return query;
    }
     ...
     * @throws SQLException
     */
    public void deletedemoBean(DemoBean demoBean) throws SQLException {
        //只看id
        dao.delete(demoBean);
    }
     ...
     * @throws SQLException
     */
    public void updateName(DemoBean demoBean, String name) throws SQLException {
